...
export default class extends Controller {
  ...
  change_to(element, meta = "") {
    this.element.querySelector("#article_fragment_element").value = element
    this.element.querySelector("#article_fragment_meta").value = meta
  ...
  delete(event) {
    ...
    this.element.querySelector("button_to").querySelector('button[type="submit"]').click()
  }
}
