...
// <a class="dropdown-item" data-action="mousedown->change-fragment#pre" style="cursor: pointer;">
//   Code Block
// </a>
// `

const change_fragment_delete = `
<a class="dropdown-item has-text-danger" data-action="mousedown->change-fragment#delete" style="cursor: pointer;">
  Delete
</a>
`
